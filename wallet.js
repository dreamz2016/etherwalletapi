...
var Wallet = function (priv, pub) {
  if (priv && pub) {
    console.log('Cannot supply both a private and a public key to the constructor')
    throw new Error('Cannot supply both a private and a public key to the constructor')
  }

  if (priv && !ethUtil.isValidPrivate(priv)) {
    console.log('Private key does not satisfy the curve requirements (ie. it is invalid)')
...
Wallet.fromV3 = function (input, password, nonStrict) {
  ...
  console.log(-1)
  assert(typeof password === 'string', 'password must be an string')
